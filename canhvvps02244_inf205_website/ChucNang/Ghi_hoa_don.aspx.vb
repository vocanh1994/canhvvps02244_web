...
Partial Class ChucNang_Ghi_hoa_don
    ...
    Protected Sub btn_ghiHD_Click(sender As Object, e As EventArgs) Handles btn_ghiHD.Click
        ...
        ketnoi.Close()
        '*********************
        Dim sql_chitiet As New SqlDataAdapter("INSERT INTO CHI_TIET_HOA_DON VALUES (" & Convert.ToInt32(txt_soluong.Text) & ", " & Convert.ToInt32(tb4.Rows((tb4.Rows.Count) - 1).Item(0).ToString) & ", " & Convert.ToInt32(tb1.Rows(0).Item(1).ToString) & ")", ketnoi)
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Response.Redirect("Xem_hoa_don.aspx")
    End Sub
End Class
